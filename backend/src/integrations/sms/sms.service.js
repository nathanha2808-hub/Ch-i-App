...
var SmsService = function () {
    ...
    var SmsService = _classThis = /** @class */ (function () {
        function SmsService_1(provider) {
            this.provider = provider;
            this.logger = new common_1.Logger(SmsService.name);
        }
        SmsService_1.prototype.generateOtp = function (length) {
        ...
        SmsService_1.prototype.sendOtp = function (phone, otp) {
            return this.provider.sendOtp(phone, otp);
        };
        SmsService_1.prototype.sendSms = function (phone, content) {
