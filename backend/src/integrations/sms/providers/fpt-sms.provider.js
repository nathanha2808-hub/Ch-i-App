 ...
 */
var FptSmsProvider = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var FptSmsProvider = _classThis = /** @class */ (function () {
        function FptSmsProvider_1() {
            this.logger = new common_1.Logger(FptSmsProvider.name);
        }
        FptSmsProvider_1.prototype.sendOtp = function (phone, otp) {
        ...
        FptSmsProvider_1.prototype.sendSms = function (phone, content) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        return FptSmsProvider_1;
    }());
    __setFunctionName(_classThis, "FptSmsProvider");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        FptSmsProvider = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FptSmsProvider = _classThis;
}();
exports.FptSmsProvider = FptSmsProvider;
