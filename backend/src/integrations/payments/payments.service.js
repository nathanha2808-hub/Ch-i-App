...
var PaymentsService = function () {
    ...
    var PaymentsService = _classThis = /** @class */ (function () {
        function PaymentsService_1(provider) {
            this.provider = provider;
            this.logger = new common_1.Logger(PaymentsService.name);
        }
        PaymentsService_1.prototype.generateDepositQr = function (transactionCode, amount) {
        ...
        PaymentsService_1.prototype.verifyWebhook = function (headers, rawBody) {
            return this.provider.verifyWebhookSignature(headers, rawBody);
        };
        PaymentsService_1.prototype.parseWebhook = function (body) {
