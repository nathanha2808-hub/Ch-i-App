...
var PushController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Push Notifications'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.Controller)('api/push'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard)];
    ...
    var PushController = _classThis = /** @class */ (function () {
        ...
        PushController_1.prototype.subscribe = function (req, body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.pushService.saveSubscription(req.user.userId, body)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, { message: 'Push subscription saved' }];
                    }
                });
            });
        };
        PushController_1.prototype.unsubscribe = function (endpoint) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.pushService.removeSubscription(endpoint)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, { message: 'Push subscription removed' }];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _subscribe_decorators = [(0, common_1.Post)('subscribe'), (0, roles_decorator_1.Roles)('CUSTOMER', 'TASKER', 'ADMIN'), (0, swagger_1.ApiOperation)({ summary: 'Đăng ký nhận Push Notification (Web Push)' })];
        _unsubscribe_decorators = [(0, common_1.Post)('unsubscribe'), (0, roles_decorator_1.Roles)('CUSTOMER', 'TASKER', 'ADMIN'), (0, swagger_1.ApiOperation)({ summary: 'Hủy đăng ký Push Notification' })];
