    ...
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        ...
        JwtStrategy_1.prototype.validate = function (payload) {
            return __awaiter(this, void 0, void 0, function () {
                var user, isBannedGracePeriod, activeOrders;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            isBannedGracePeriod = false;
                            if (!(user.status === 'LOCKED' || user.status === 'BANNED' || user.status === 'INACTIVE')) return [3 /*break*/, 4];
                            if (!(user.role === 'TASKER')) return [3 /*break*/, 3];
                            return [4 /*yield*/, this.prisma.orders.count({
                                    where: {
                        ...
                        case 2:
                            ...
                            return [3 /*break*/, 4];
                        case 3: throw new common_1.UnauthorizedException('Tài khoản của bạn đã bị khóa');
                        case 4: return [2 /*return*/, { userId: payload.sub, phone: payload.phone, role: payload.role, isBannedGracePeriod: isBannedGracePeriod }];
                    }
                });
            });
        };
