...
var ResetPasswordDto = function () {
    ...
    return _a = /** @class */ (function () {
            function ResetPasswordDto() {
                ...
                this.new_password = (__runInitializers(this, _otp_extraInitializers), __runInitializers(this, _new_password_initializers, void 0));
        ...
        (function () {
            ...
            _otp_decorators = [(0, swagger_1.ApiProperty)({ example: '123456' }), (0, class_validator_1.IsString)(), (0, class_validator_1.Length)(4, 8, { message: 'OTP phải từ 4-8 ký tự' })];
            _new_password_decorators = [(0, swagger_1.ApiProperty)({ example: 'newpassword123' }), (0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(8, { message: 'Mật khẩu mới tối thiểu 8 ký tự' }), (0, class_validator_1.Matches)(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).*$/, { message: 'Mật khẩu phải chứa ít nhất 1 chữ hoa, 1 chữ thường, 1 số và 1 ký tự đặc biệt' })];
