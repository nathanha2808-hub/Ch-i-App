...
exports.ReviewOrderDto = void 0;
var class_validator_1 = require("class-validator");
var swagger_1 = require("@nestjs/swagger");
var ReviewOrderDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _rating_decorators = [(0, swagger_1.ApiProperty)({ example: 5, minimum: 1, maximum: 5 }), (0, class_validator_1.IsInt)({ message: 'Rating phải là số nguyên 1-5' }), (0, class_validator_1.Min)(1), (0, class_validator_1.Max)(5)];
            _comment_decorators = [(0, swagger_1.ApiProperty)({ example: 'Làm việc rất sạch sẽ và đúng giờ', required: false }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(1000, { message: 'Bình luận tối đa 1000 ký tự' })];
